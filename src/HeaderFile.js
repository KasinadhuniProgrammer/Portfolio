...
function HeaderFile() {
    ...
    return (
        <div className="headerfile">
            ...
            <center><button onClick={() => {openInNewTab("https://github.com/KasinadhuniProgrammer")}} className="github-button"><h5>GitHub</h5></button></center>
            <center><button onClick={() => {openInNewTab("https://www.linkedin.com/in/satvik-kasinadhuni/")}}className="linkedin-button"><h5>Linkedin</h5></button></center>
