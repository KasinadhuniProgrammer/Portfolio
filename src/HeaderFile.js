...
function HeaderFile() {
    ...
    return (
        <div className="headerfile">
            ...
            <center><button onClick={() => {openInNewTab("https://github.com/KasinadhuniProgrammer")}} className="github-button">GitHub</button></center>
            <center><button onClick={() => {openInNewTab("https://www.linkedin.com/in/satvik-kasinadhuni/")}}className="linkedin-button">Linkedin</button></center>
