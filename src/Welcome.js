...
function Welcome() {
    ...
    return(
        <div className="welcome">
            ...
            <center><h3 className="secondpara__welcome">I mainly do lots of Full Stack development with React.js and Firebase. But I also have experience with developing Tcl/Tk applications using Python, operating Linux Systems, and Java Programming.</h3></center>
            <center><h3 className="thirdpara__welcome">I am a Sophomore at Farmington High School and am taking many STEM courses. In Freshman year, I took Honors Physics, Geometry, Algebra 2A, and AP Computer Science Principles. Currently, I am taking Chemistry Honors, Algebra 2B, AP Computer Science A, and Principles of Engineering Honors. I am also involved in some extracurricular STEM activities such as, being part of my schools Hack Club, and being part of a First Tech Challenge team.</h3></center>
            <center><h3 className="fourthpara__welcome">I am currently seeking a summer Software Engineering Internship.</h3></center>
            <center><h3 className="fifthpara__welcome">After High School, I am interested to go to college and study both Computer Science and Electrical Engineering. After four years in college, I am interested to work for a company as a Software Engineer.</h3></center>
