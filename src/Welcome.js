...
function Welcome() {
    ...
    return(
        <div className="welcome">
            ...
            <center><h3 className="fifthpara__welcome">After High School, I am interested to go to college and study both Computer Science and Electrical Engineering. After four years in college, I am interested to pursue a Masters degree in Electrical Engineering and eventually work for a company as an Electrical Engineer.</h3></center>
